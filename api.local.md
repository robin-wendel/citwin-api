...
```bash
curl -s http://localhost:8002/jobs/2d219f5f-cb63-4089-98d7-4632aaaa4dde | jq
```

```bash
curl -s http://localhost:8002/jobs/2d219f5f-cb63-4089-98d7-4632aaaa4dde/downloads | jq
```

```bash
curl -OJ http://localhost:8002/jobs/2d219f5f-cb63-4089-98d7-4632aaaa4dde/download/netascore_gpkg
curl -OJ http://localhost:8002/jobs/2d219f5f-cb63-4089-98d7-4632aaaa4dde/download/stops_updated
```
